# 0256. 補齊 NIP-11 文件與 NIP-62 清除請求，並更新 MLS 規格指標

- 狀態：**已接受（已實作）**
- 日期：2026-07-27
- 相關文件：ADR-0255（NIP 適用性盤點——本 ADR 承接其 Tier 1 三項）、
